 ...
 * @param {string} userName Name shown in the bottom user block.
 * @param {string} initials Avatar fallback initials.
 * @param {string} plan     Optional secondary label under the username.
 */
export default function Sidebar({ active, userName = 'Alex J.', initials = 'AJ', plan }) {
  return (
